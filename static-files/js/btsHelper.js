 ...
 */
BtsHelper.prototype.buildButton = function(innerText, btnClass) {
 ...
 */
BtsHelper.prototype.emptyChild = function(element) {
 ...
 */
BtsPaginationHelper.prototype.buildElement = function(textArr) {
 ...
 */
BtsPaginationHelper.prototype.buildPaginationElement = 
    function(selectedIndex, pageSize, totalCount, onIndexSelectFn) {
 ...
 */
BtsPaginationHelper.prototype.buildElementWithEvent = function(items) {
    var element = document.createElement("ul");
    element.classList.add("pagination");
 ...
 */
BtsPaginationHelper.prototype.setActiveItem = function(element, index) {
  ...
  */
BtsPaginationHelper.prototype.setItem = function(element, index, text, selectFn) {
    var items = element.querySelectorAll("li");
 ...
 * Callback to handle when pagination page item is selected (clicked)
 * @callback BtsPaginationHelper~itemSelectedCallback
 * @param {Number} index - page number index, start with zero
 */
 ...
 */
BtsDialogModalHelper.prototype.setTitle = function(element, title) {
 ...
 */
BtsDialogModalHelper.prototype.getBody = function(element) {
 ...
 * @return {Element}  HTML DIV element
 */
BtsDialogModalHelper.prototype.getFooter = function(element) {
 ...
 * @return {Element}  HTML DIV element
 */
BtsDialogModalHelper.prototype.getHeader = function(element) {
    return element.querySelector('.modal-header');
}

//======================= Combobox ===============================//
function BtsComboboxHelper() {}
 ...
 */
BtsComboboxHelper.prototype.buildElement = function(items) {
 ...
 * @param {string} items[].value - combobox item's value written in HTML tag 
 */
BtsComboboxHelper.prototype.rebuildItems = function(element, items) {
    while(element.firstChild)
        element.removeChild(element.firstChild);
...
window.btsHelper = new BtsHelper();
window.btsPaginationHelper = new BtsPaginationHelper();
window.btsDialogModalHelper = new BtsDialogModalHelper();
